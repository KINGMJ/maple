...
function randomSiteCover(){var e=Math.floor(30*Math.random()+1);$(".site-header").css("background-image","url("+Maple.blogUrl+"/assets/images/30+wallpaper/bg-cover"+e+".jpg)")}$(function(){var e;Maple.enableRandomCover&&randomSiteCover(),$(".indicator").click(function(){var e=$(".site-content").offset().top;$("html,body").animate({scrollTop:e},500)}),$("body").hasClass("paged")&&(e=$(".site-content").offset().top,$("html,body").animate({scrollTop:e},0),$(".site-header").removeClass("invisible"))});